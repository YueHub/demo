...
void writeExample1(int val) {
    ...
    std::string filename = "single_int32_example1_val" + std::to_string(val) + "_result";
...
void writeExample2(int val, int more) {
    ...
    std::string filename = "";
    if (more == 0) {
        example2.add_int32val(val);
        filename = "single_int32_example2_val" + std::to_string(val) + "_result";
    } else {
        example2.add_int32val(val);
        example2.add_int32val(more);
        filename = "single_int32_example2_val" + std::to_string(val) + "+" + std::to_string(more) + "_result";
    }
