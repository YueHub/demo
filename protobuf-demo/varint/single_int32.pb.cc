...
static void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "single_int32.proto", schemas, file_default_instances, TableStruct::offsets,
...
const int Example1::kInt32ValFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

Example1::Example1()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_single_5fint32_2eproto::scc_info_Example1.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* Example1::descriptor() {
  ::protobuf_single_5fint32_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_single_5fint32_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const Example1& Example1::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_single_5fint32_2eproto::scc_info_Example1.base);
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 666: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(208u /* 5328 & 0xFF */)) {
...
void Example1::SerializeWithCachedSizes(
  ...
  // int32 int32Val = 666;
  if (this->int32val() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(666, this->int32val(), output);
  }
...
::google::protobuf::uint8* Example1::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 int32Val = 666;
  if (this->int32val() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(666, this->int32val(), target);
  }
...
::google::protobuf::Metadata Example1::GetMetadata() const {
  protobuf_single_5fint32_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_single_5fint32_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int Example2::kInt32ValFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

Example2::Example2()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_single_5fint32_2eproto::scc_info_Example2.base);
  SharedCtor();
...
const Example2& Example2::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_single_5fint32_2eproto::scc_info_Example2.base);
  return *internal_default_instance();
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(4294967293u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 536870911: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(250u /* 4294967290 & 0xFF */)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_int32val())));
        } else if (
            static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(248u /* 4294967288 & 0xFF */)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 5, 4294967290u, input, this->mutable_int32val())));
        } else {
          goto handle_unusual;
        }
        break;
...
void Example2::SerializeWithCachedSizes(
  ...
  // repeated int32 int32Val = 536870911;
  if (this->int32val_size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteTag(536870911, ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED, output);
    output->WriteVarint32(static_cast< ::google::protobuf::uint32>(
        _int32val_cached_byte_size_));
  }
  for (int i = 0, n = this->int32val_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32NoTag(
      this->int32val(i), output);
  }
  ...
  if (this->int32val_size() > 0) {
    ...
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        static_cast< ::google::protobuf::int32>(
            _int32val_cached_byte_size_), target);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32NoTagToArray(this->int32val_, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Example2)
  ...
  // repeated int32 int32Val = 536870911;
  {
    ...
    _int32val_cached_byte_size_ = cached_size;
...
// @@protoc_insertion_point(class_specific_merge_from_start:Example2)
  ...
  int32val_.MergeFrom(from.int32val_);
}
...
void Example2::InternalSwap(Example2* other) {
  using std::swap;
  int32val_.InternalSwap(&other->int32val_);
  _internal_metadata_.Swap(&other->_internal_metadata_);
}
